...
@section('title', 'Nuevo Libro - Librería & Cine')
@section('page-title', 'Agregar Nuevo Libro')
@section('page-subtitle', 'Completa la información del libro')
                    ...
                    <form action="{{ route('libros.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control @error('paginas') is-invalid @enderror" id="paginas" name="paginas" value="{{ old('paginas') }}">
                                @error('paginas')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <!-- Imagen -->
                            <div class="col-md-6 mb-3">
                                <label for="foto" class="form-label">Imagen de Portada</label>
